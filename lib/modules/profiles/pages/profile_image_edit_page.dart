...
import '../blocs/profile_image_blocs/profile_image_event.dart';
import '../blocs/profile_image_blocs/profile_image_state.dart';
    ...
    try {
      ...
      if (mounted) {
        context.read<ProfileImageBloc>().add(
          ProfileImageUpload(widget.profileId, outputFile.path),
        );
      }
    } catch (_) {
      if (mounted) {
      ...
      listener: (context, state) {
        if (state is ProfileImageSuccess) {
          SnackBarUtils.showSuccess(
            context,
            'profile.profile_image.upload_success'.tr(),
          );
          Navigator.of(context).pop(state.profileImage.avatarUrl);
          ...
          SnackBarUtils.showError(
            context,
            'profile.profile_image.upload_error'.tr(),
          );
        }
      },
      child: Scaffold(
                  ...
                  return Align(
                    ...
                    child: SizedBox(
                      ...
                      child: _isLoadingImage
                          ...
                          ? Center(
                              child: Text(
                                'profile.profile_image_edit.no_image_selected'
                                    .tr(),
